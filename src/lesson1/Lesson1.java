...
public class Lesson1 {
    ...
    private void exercise1() {
        ...
        //            the list of Strings provided. HINT: Use a StringBuilder to construct the result.
    ...
    private void exercise4() {
        ...
        //            StringBuilder to construct the result String. Use one of the new JDK 8 methods for Map.
        StringBuilder sb = new StringBuilder();
